    ...
    <section className="px-4 pb-16 pt-4 md:px-6 md:pb-20">
      <div className="section-shell">
        <motion.div
          ...
          className="relative overflow-hidden rounded-[32px] border border-white/10 bg-[#060606] text-white shadow-[0_30px_120px_rgba(0,0,0,0.35)] lg:min-h-[430px]"
        >
          ...
          <div className="relative grid gap-0 lg:grid-cols-[1.12fr_1fr]">
            <div className="flex flex-col justify-center px-5 py-7 sm:px-6 sm:py-7 md:px-8 md:py-8 lg:px-9 lg:py-10">
              <div>
                ...
                <p className="mt-5 max-w-xl text-[15px] leading-7 text-white/72 md:text-base md:leading-8">
                  From stadium concerts and sports leagues to gaming activations and outreach
                  campaigns, Raven Rows designs and delivers high-energy experiences at scale.
                </p>
            ...
            <div className="relative min-h-[340px] overflow-hidden lg:h-full lg:min-h-[430px]">
              <div
                className="absolute inset-0 bg-cover bg-center transition duration-700 hover:scale-[1.03]"
                style={{
                  backgroundImage:
                    "linear-gradient(to top, rgba(8,12,24,0.82), rgba(8,12,24,0.20)), url('/images/concert.jpg')",
                }}
              />
              ...
              <div className="relative flex h-full min-h-[340px] flex-col justify-end p-6 text-white md:p-7">
                <div className="max-w-[520px]">
                  ...
                  <h4 className="mt-4 text-[26px] font-semibold leading-[1.02] tracking-[-0.05em] text-white sm:text-[30px] lg:text-[32px]">
                    Concerts & leagues at scale
                  </h4>

                  <p className="mt-4 max-w-[500px] text-sm leading-7 text-white/80">
                    Armaan Malik, King, MC Square, Free Fire events, and doctor leagues executed
                    with premium production and audience-first thinking.
                  </p>

                  <div className="mt-5 flex flex-wrap gap-2">
                    {["Concerts", "Sports", "Live"].map((tag) => (
                      <span
                        key={tag}
